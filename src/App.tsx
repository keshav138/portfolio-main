        ...
        {isLoading ? (
          ...
          >
            ...
            <motion.div 
              ...
              className="fixed top-0 w-full border-b border-[#333] bg-[#0A0A0A]/80 backdrop-blur-md py-1.5 overflow-hidden z-50"
            >
              <div className="flex whitespace-nowrap animate-marquee font-mono text-[9px] md:text-[10px] text-[#888] tracking-[0.2em]">
                {[...Array(4)].map((_, i) => (
            ...
            <motion.div 
              ...
              animate={{ y: 0 }}
              transition={{ duration: 1.2, ease: [0.76, 0, 0.24, 1], delay: 0.2 }}
              className="fixed bottom-0 w-full border-t border-[#333] bg-[#0A0A0A]/80 backdrop-blur-md py-1.5 overflow-hidden z-50"
            >
              <div className="flex whitespace-nowrap animate-marquee font-mono text-[9px] md:text-[10px] text-[#888] tracking-[0.2em]">
                {[...Array(4)].map((_, i) => (
                  <span key={i} className="mx-4">
